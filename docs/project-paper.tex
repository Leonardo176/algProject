...
\begin{document}
	...
	\section{Theoretical Background}
		...
		\subsection{Red Black Tree (RBT)}
			...
			Instead functions for insertion and removal are adapted in a way that the keep the conditions listed above,
			such that an RBT remains an RBT when inserting or removing elements.
